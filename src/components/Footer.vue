  ...
  <section class="fixed bottom-0 w-full">
    <div class="flex gap-5 h-full px-6">
      <a href="https://www.linkedin.com/in/john-hines-788893183/">
        <svg class="h-full hover:text-[#E59500] text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.8 25.7" >
          <g fill="#010202">
      ...
      <a href="https://github.com/SanctusFides" >
        <svg class="h-full hover:text-[#E59500] mb-4 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >

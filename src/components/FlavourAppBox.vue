<script setup>
  import flavour from '@/assets/img/flavourpalette.png';
  ...
  <div class="flex flex-col gap-4 md:flex-row md:gap-2 text-center md:text-left md:justify-between basis-1/2
    ...
    <div class="flex flex-col justify-between">
      <div class="flex justify-center">
        <img class="max-h-48 min-w-[259px]" :src="flavour" alt="flavour palette web app thumbnail">
      </div>
      <div>
        <h3 class="text-jyellow text-2xl text-center"> Flavour Palette </h3>
        <p class="text-base mb-4 text-center">Java & Spring Boot web app that allows users to search, create, favorite and rate recipes. 
